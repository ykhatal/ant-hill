...
QueenAnt.prototype = {
  ...
  createServer: function() {
    ...
    net.createServer(function(socket) {
      ...
      logger.info('There is ' + self.getWorkerAnts() + ' connected simultanously');
      ...
      socket.on('message', function(message) {
        ...
        case 'CONNECTED':
          ...
          self.sendToWorkerAnt(workerAnt.id, { type: 'CMD', cmd: 'START' });
          break;
        case 'READY':
          self.setWorkerAntState(workerAnt, self.antStates.READY);
  ...
  getWorkerAntState: function(workerAnt) {
    var self = this;
    self.sendToWorkerAnt(workerAnt.id, { type: 'CMD', cmd: 'GET-STATUS' });
  ...
  sendToWorkerAnt: function(workerAntId, message) {
    _.first(_.where(this.workerAnts, { 'id': workerAntId })).socket.sendMessage(message);
